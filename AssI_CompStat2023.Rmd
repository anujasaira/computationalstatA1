...
#Histograms and densities for different value of gamma for X
p1=ggplot(data.frame(x=x1), aes(x)) +
  geom_histogram(aes(y=..density..), fill="gray",col="darkblue")+
  labs(x="X gamma=3",y="Density")+
  geom_density()
p2=ggplot(data.frame(x=x2), aes(x)) +
  geom_histogram(aes(y=..density..), fill="gray",col="darkblue")+
  labs(x="X gamma=15",y="Density")+
  geom_density()
p3=ggplot(data.frame(x=x3), aes(x)) +
  geom_histogram(aes(y=..density..), fill="gray",col="darkblue")+
  labs(x="X gamma=25",y="Density")+
  geom_density()
p1+p2+p3
```
```{r}
