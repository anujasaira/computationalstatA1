...
![Decision Tree](tree_example.png){width="245"}
...
![Bagging Regession Tree](baggreg.png){width="281"}
...
![Figure 3: Misclassification Rate](largedataerr.png){width="168" height="91"}
...
![Prediction error for subset selection and bagged subset selection](aleimm.png){width="365"}
...
![Table diabetes dataset, number of bootstrap replicates](MissClassificationRate%20vs%20Num%20Bootstrap.png){width="307"}
