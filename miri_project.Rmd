...
To better understand stability and instability, and what bagging do, we define the concepts of bias and variance for classifiers. Unstable classifiers, such as trees, characteristically have high variance and low bias. Stable classifiers, like linear discriminant analysis, have low variance, but can have high bias.
